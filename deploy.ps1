...
cd "D:\Education\Programming\Java\wso2-custom-executor-master"
...
copy ".\target\com.mycompany.wso2.workflow-1.0.0.jar" "C:\wso2am-4.2.0\repository\components\dropins\"
